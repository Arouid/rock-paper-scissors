...
document.getElementById('rockBtn').addEventListener('click', () => playerSelect('Rock'));
document.getElementById('paperBtn').addEventListener('click', () => playerSelect('Paper'));
document.getElementById('scissorsBtn').addEventListener('click', () => playerSelect('Scissors'));
